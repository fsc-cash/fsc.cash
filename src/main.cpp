...
static CBigNum bnProofOfWorkLimitTestNet(~uint256(0) >> 18);
static CBigNum bnProofOfStakeLimitTestNet(~uint256(0) >> 18);
...
int64 nChainStartTime = 1509371747;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 10000000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2018/1/30 PM 9:00 build FoodSafetyCoin in office.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x7f28184947b69b2d1eacbc99f9a864f78bebc4df481a683c122dcb866e9a12fa"));
...
string GetWarnings(string strFor)
{
    ...
    if (Checkpoints::IsSyncCheckpointTooOld(60 * 60 * 24 * 3650) && !fTestNet && !IsInitialBlockDownload())
    {
        nPriority = 100;
...
unsigned char pchMessageStart[4] = { 0x12, 0x73, 0x5e, 0xf2 };
